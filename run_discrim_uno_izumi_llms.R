# =========================
# File: run_discrim_uno_izumi_llms.R
# Purpose: RF discrimination analysis (Uno vs. Izumi) 
...
cfg <- list(
  ...
  out_file = "Uno_Izumi_RF_results.xlsx",
  seed = 123,
  ...
  train_human = c("Uno", "Izumi"),
  class_order = c("Uno", "Izumi"),
  positive_class = "Uno"
)
...
# Map LLM-generated Categories back to their target human author (Uno or Izumi)
# e.g., "Gemini_Uno" -> "Uno"
